...
// @CS0522
// Changed default fieldlength value
const string CoreWorkload::FIELD_LENGTH_DEFAULT = "4096";
...
const string CoreWorkload::ZERO_PADDING_DEFAULT = "20";  // key 24-byte. user(4-byte) + zeropadding(20-byte)
...
void CoreWorkload::BuildValues(std::vector<ycsbc::DB::KVPair> &values, const std::string& key) {
